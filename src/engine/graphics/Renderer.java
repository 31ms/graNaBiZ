...
public class Renderer {
    ...
    public static void init(Window window){
        ...
        setBackgroundColor(new Vector4(0, .2, .1, 1));
    }
    ...
    public static void render(Scene scene){
        ...
        // Iterating scene ArrayList and calls object's render method
            for (Object2D object : scene.opaque){
                object.render();
            }
            for (Object2D object : scene.transparent){
                object.render();
            }
        }
    ...
    public static void setBackgroundColor(Vector4 v){
        // Setting color of the background
        glClearColor((float)v.x, (float)v.y, (float)v.z, (float)v.w);
    }
}
